...
var core = {
    ...
    extend: function(prop) {
        ...
        for(var name in prop) {
            prototype[name] = typeof prop[name]=='function' && typeof _super[name]=='function' && this.fnTest(prop[name]) ? createFunc(name, prop[name]) : prop[name];
        }

    },
    createFunc: function(name, fn) {
        return function() {
            var tmp = this._super;
